...
<body onload="time()" class="app sidebar-mini rtl">
  ...
  <aside class="app-sidebar">
    ...
    <ul class="app-menu">
      ...
      <li><a class="app-menu__item " href="/admin/QuanLyDonHang"><i class='app-menu__icon bx bx-task'></i><span class="app-menu__label ">Quản lý đơn hàng</span></a></li>
      <li><a class="app-menu__item active" href="/admin/QuanLyThuongHieu"><i class='app-menu__icon bx bx-dollar'></i><span class="app-menu__label">Quản lý thương hiệu</span></a></li>
  ...
  <main class="app-content">
    <div class="app-title">
      <ul class="app-breadcrumb breadcrumb side">
        <li class="breadcrumb-item "><a href="#"><b>Quản lý thương hiệu</b></a></li>
      </ul>
      <div id="clock"></div>
    </div>
    <div class="row">
          ...
          <div class="tile-body">
            <div class="row element-button">
              <div class="col-sm-2">
                ...
                <a class="btn btn-add btn-sm" href="/admin/QuanLyThuongHieu/?Insert=true" title="Thêm"><i class="fas fa-plus"></i>
              ...
              <!-- <div class="col-sm-2">
                ...
                <div class="col-sm-2">
                <a class="btn btn-delete btn-sm" type="button" title="Xóa" href="/admin/QuanLyThuongHieu/?delAll" onclick="return confirm('Bạn chắn chắn muốn xoá tất cả chứ ?')" style="color: #000;"><i
              ...
              <tbody>
                ...
                <?php foreach ($categories as $category) { ?>
                  ...
                  <td width="10"><?php echo $cnt; ?></td>
                    ...
                    <td><?php echo $category['name_brand'] ?></td>
                    ...
                    <td class="table-td-center">
                        <a href="/admin/QuanLyThuongHieu/?deleteBrand=<?php echo $category['id'] ?>" 
                          class="btn trash"title="Xóa"><i class="fas fa-trash-alt"></i>
                        </a>
                      <a class="btn btn-primary btn-sm edit" href="/admin/QuanLyThuongHieu/?UpdateTH=<?php echo $category['id']; ?>" title="Chỉnh sửa danh mục" id="show-emp"><i class="fas fa-edit"></i>
                      </a>
                    </td>
                  </tr>
                <?php } ?>
