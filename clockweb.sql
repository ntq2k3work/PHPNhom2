...
--
CREATE DATABASE IF NOT EXISTS clockweb;
USE clockweb;
-- --------------------------------------------------------
...
CREATE TABLE `material` (
  `id` int NOT NULL,
  `wire_material` varchar(200) CHARACTER SET utf8mb4 NOT NULL,
  `glass_material` varchar(200) CHARACTER SET utf8mb4 DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
